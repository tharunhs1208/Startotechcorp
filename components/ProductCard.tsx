...
export default function ProductCard({ product, onOpenDemo, onExpandDetails }: ProductCardProps) {
  ...
  return (
    <div
      ...
      className="group relative h-[440px] sm:h-[480px] w-full rounded-3xl overflow-hidden bg-black border border-white/10 hover:border-[#e70000]/60 transition-all duration-500 shadow-2xl hover:shadow-[0_20px_50px_rgba(231,0,0,0.25)] flex flex-col justify-between cursor-pointer"
    >
      ...
      {/* 4. Top Play Indicator Badge */}
      <div className="relative z-10 p-6 flex items-center justify-between">
        <div className="w-10 h-10 rounded-full bg-black/60 backdrop-blur-md border border-white/15 flex items-center justify-center text-white group-hover:bg-[#e70000] group-hover:border-[#e70000] transition-all duration-300 shadow-lg">
          {isHovered ? (
            ...
            <Play className="w-4 h-4 fill-white ml-0.5 opacity-90" />
          )}
        </div>
      </div>
      ...
      <div className="relative z-10 p-6 sm:p-8 bg-gradient-to-t from-black/95 via-black/80 to-transparent">
        <h3 className="text-2xl sm:text-3xl font-black text-white uppercase tracking-tight mb-2 group-hover:text-[#e70000] transition-colors">
          {product.name}
        </h3>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-white/10">
          ...
          <div className="w-9 h-9 rounded-full bg-white/10 group-hover:bg-[#e70000] border border-white/15 flex items-center justify-center text-white transition-all duration-300 group-hover:translate-x-1">
